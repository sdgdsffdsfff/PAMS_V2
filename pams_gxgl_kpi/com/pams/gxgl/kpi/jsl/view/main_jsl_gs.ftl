...
<#include "/page/view/com/ray/nwpn/itsm/report/common/view/script.ftl">

<script>

function page_load_jsl_table()
{
	page_load_table("${base}/module/pams/gxgl/kpi/jsl/rep_tab_jsl_gs.action", "jsl", 0, new Array("internal","reptype"), new Array("${obj.internal}","${obj.reptype}"));
}
...
function page_query_export()
{
	...
	form_advsearch.action = "${base}/module/pams/gxgl/kpi/jsl/rep_xls_jsl_gs.action";
