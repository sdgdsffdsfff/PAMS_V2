...
<tr>
<td>${aobj_index+1}</td>
<td><a href="${base}/module/pams/gxgl/rep/zxqk/gxd/rep/main_zxqk_yfqzs.action?ownerctx=${aobj.loginname}&reptype=${obj.reptype}&begindate=${obj.begindate}&enddate=${obj.enddate}">${aobj.username}</a></td>
