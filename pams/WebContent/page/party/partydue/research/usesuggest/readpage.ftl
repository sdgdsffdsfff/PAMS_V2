...
function page_apply()
{
	var url = "${base}/party/partydue/research/usesuggest/apply.action?runactkey=${obj.runactkey}";	 
	window.location = url;
}
...
function page_edit()
{
	var url = "${base}/party/partydue/research/usesuggest/locate.action?runactkey=${obj.runactkey}";	 
	window.location = url;
}
