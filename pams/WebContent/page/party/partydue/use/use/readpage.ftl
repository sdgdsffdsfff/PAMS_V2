...
<div id="gscontent" style="margin:10px;">
	...
	<br/>
	  ...
	  <div class="container"> 
	    <h4><i class="fa fa-group"></i> 党费使用申请表</h4>
	    ...
	    <h5><a href="#1"><i class="fa fa-calendar"></i> 基本信息</a></h5>
	     <div class="form-group">
	        ...
	        <div class="col-sm-10"> 
	          <input id="cname" name="cname" required="" value="${obj.usedetail.cname}" class="form-control">
	        </div>           
	      </div>
	 
	      <div class="form-group">
	        <label for="creatercname" class="col-sm-2 control-label">开始时间：<sup class="fa fa-asterisk"></sup></label>
	        <div class="col-sm-4"> 
	          <input id="chargername" name="chargername" required="" value="${obj.usedetail.chargername}" class="form-control">
	        </div>
	        <label for="cyear" class="col-sm-2 control-label">结束时间：<sup class="fa fa-asterisk"></sup></label>
	        <div class="col-sm-4"> 
	          <input id="context" name="context" required="" value="${obj.usedetail.context}" class="form-control">
	        </div>            
	      </div> 
	      
	      <div class="form-group">
	        <label for="creatercname" class="col-sm-2 control-label">项目负责人：<sup class="fa fa-asterisk"></sup></label>
	        <div class="col-sm-4"> 
	          <input id="chargername" name="chargername" required="" value="${obj.usedetail.chargername}" class="form-control">
	        </div>
	        <label for="cyear" class="col-sm-2 control-label">计划费用：<sup class="fa fa-asterisk"></sup></label>
	        <div class="col-sm-4"> 
	          <input id="context" name="context" required="" value="${obj.usedetail.context}" class="form-control">
	        </div>            
	      </div> 
	      ...
	      <div class="form-group">
	        <label for="creatercname" class="col-sm-2 control-label">项目内容：<sup class="fa fa-asterisk"></sup></label>
	        <div class="col-sm-4"> 
	          <input id="chargername" name="chargername" required="" value="${obj.usedetail.chargername}" class="form-control">
	        </div>
...
function page_apply()
{
	var url = "${base}/party/partydue/use/use/apply.action?runactkey=${obj.runactkey}";	 
	window.location = url;
}
...
function page_edit()
{
	var url = "${base}/party/partydue/use/use/locate.action?runactkey=${obj.runactkey}";	 
	window.location = url;
}
