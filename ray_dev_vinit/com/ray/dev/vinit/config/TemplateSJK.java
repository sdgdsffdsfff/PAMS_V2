...
public class TemplateSJK
{
	public static List get_sjk()
	{
		List<String[]> items = new ArrayList();
		items.addAll(get_sjk_jbsx_all());
		items.addAll(get_sjk_gjsx_all());
		items.addAll(get_sjk_glsx_all());
		return items;
	}
	
	// 获取全部基本属性
	public static List get_sjk_jbsx_all()
	{
		List<String[]> items = new ArrayList();
		items.addAll(get_sjk_jbsx());
		
		return items;
	}
	
	// 获取基本属性(简单属性)
	public static List get_sjk_jbsx()
	{
		List<String[]> items = new ArrayList();
		...
		items.add(new String[]{"数据库类别","sjklb","","",""});
	...
	// 获取全部固件属性
	public static List get_sjk_gjsx_all()
	{
		List<String[]> items = new ArrayList();
		
		items.addAll(get_sjk_gjsx_dk());
		
		return items;
	}
	
	//获取固件属性（端口子项）
	public static List get_sjk_gjsx_dk()
	{
		List<String[]> items = new ArrayList();
	...
	// 获取全部管理属性
	public static List get_sjk_glsx_all()
	{
		List<String[]> items = new ArrayList();
		items.addAll(get_sjk_glsx());
		items.addAll(get_sjk_glsx_glzhxx());
		
		return items;
	}

	//获取管理属性（简单属性）
	public static List get_sjk_glsx()
	{
		List<String[]> items = new ArrayList();
	...
	//获取管理属性（管理帐号信息子项）
	public static List get_sjk_glsx_glzhxx()
	{
		List<String[]> items = new ArrayList();
