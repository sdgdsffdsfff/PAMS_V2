...
function page_apply()
{
	var url = "${base}/party/partydue/collect/collectbudget/apply.action?runactkey=${obj.runactkey}";	 
	window.location = url;
}
...
function page_edit()
{
	var url = "${base}/party/partydue/collect/collectbudget/locate.action?runactkey=${obj.runactkey}";	 
	window.location = url;
}
