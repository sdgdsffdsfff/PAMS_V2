...
<td><a href="${base}/module/pams/gxgl/kpi/jsl/rep/main_jsl_ry.action?internal=${aobj.internal}&reptype=${obj.reptype}&begindate=${obj.begindate}&enddate=${obj.enddate}">${aobj.orgcname}</a></td>
