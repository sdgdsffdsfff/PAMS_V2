...
<h2><span class="title tab_wjgx">按部门统计</span><span class="more"></span></h2>
...
{
	page_load_table("${base}/module/pams/gxgl/kpi/jsl/rep/tab_jsl_bm.action", "wjgx", 0, new Array("internal","reptype"), new Array("${obj.internal}","${obj.reptype}"));
}
...
function page_query_export()
{
	...
	form_advsearch.action = "${base}/module/pams/gxgl/kpi/jsl/rep/xls_jsl_bm.action";
