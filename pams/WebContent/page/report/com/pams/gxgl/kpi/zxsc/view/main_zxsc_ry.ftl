...
{
	page_load_table("${base}/module/pams/gxgl/kpi/zxsc/rep/tab_zxsc_ry.action", "zxsc", 0, new Array("internal","orginternal","reptype"), new Array("${obj.internal}","${obj.orginternal}","${obj.reptype}"));
}
...
function page_query_export()
{
	...
	form_advsearch.action = "${base}/module/pams/gxgl/kpi/zxsc/rep/xls_zxsc_ry.action";
