...
{
	page_load_table("${base}/module/pams/gxgl/kpi/zxsc/rep_tab_zxsc_bm.action", "zxsc", 0, new Array("internal","reptype"), new Array("${arg.internal}","${arg.reptype}"));
}
...
function page_query_export()
{
	...
	form_advsearch.action = "${base}/module/pams/gxgl/kpi/zxsc/rep_xls_zxsc_bm.action";
