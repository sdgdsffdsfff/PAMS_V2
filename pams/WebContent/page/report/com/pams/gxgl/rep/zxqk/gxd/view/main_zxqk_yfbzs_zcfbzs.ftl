...
{
	page_load_table("${base}/module/pams/gxgl/rep/zxqk/gxd/rep_tab_zxqk_yfbzs_zcfbzs.action", "zxscmx", 0, new Array("ownerctx","reptype"), new Array("${arg.ownerctx}","${arg.reptype}"));
}
