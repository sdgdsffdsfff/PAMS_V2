...
<h2><span class="title tab_jsl">按人员统计</span><span class="more"></span></h2>
...
{
	page_load_table("${base}/module/pams/gxgl/kpi/jsl/rep/tab_jsl_ry.action", "jsl", 0, new Array("internal","orginternal","reptype"), new Array("${obj.internal}","${obj.orginternal}","${obj.reptype}"));
}
...
function page_query_export()
{
	...
	form_advsearch.action = "${base}/module/pams/gxgl/kpi/jsl/rep/xls_jsl_ry.action";
