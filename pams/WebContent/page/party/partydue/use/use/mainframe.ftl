  ...
  <body>
    <div id="gsLayoutContainer">
      ...
      <div id="leftNavi">
        ...
        <ul class="sub">
        <li><a href="${base}/party/partydue/use/use/browseplan.action">待执行计划</a></li>
        ...
        <li class="active"> 
            ...
            <ul class="sub">
              ...
              <li class="active"> <a href="${base}/party/partydue/use/use/browsewait.action">个人待办业务</a></li>
              <li><a href="${base}/party/partydue/use/use/browsehandle.action">个人已办业务</a></li>
      ...
      <div id="gsLayoutContainer-right">
        <iframe src="${base}/party/partydue/use/use/browsewait.action" frameborder="0" name="rightFrame" allowtransparency="true"></iframe>
      </div>
    </div>
