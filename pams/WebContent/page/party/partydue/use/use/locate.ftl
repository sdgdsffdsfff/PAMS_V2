...
<div id="gscontent" style="margin:10px;">
	...
	<div class="">
		<div class="opleft">
			...
			<button id="bt_add" class="btn btn-primary" onclick="window.open('${base}/party/partydue/use/use/inputdetail.action?id=${obj.useid}')">新增</button>
  ...
  <div class="container"> 
    ...
    <h5><a href="#1"><i class="fa fa-calendar"></i> 基本信息</a></h5>
     <div class="form-group">
        ...
        <div class="col-sm-10"> 
          <input id="cname" name="cname" required="" value="${obj.use.cname}" class="form-control">
        </div>           
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4"> 
          <input id="creatercname" name="creatercname" required="" value="${obj.use.creatercname}" class="form-control">
        </div>
        <label for="cyear" class="col-sm-2 control-label">征集年份：<sup class="fa fa-asterisk"></sup></label>
        <div class="col-sm-4"> 
          <input id="cyear" name="cyear" required="" value="${obj.use.cyear}" class="form-control">
        </div>            
      </div> 
      </div>
      </form>
...
{
	detailform.action = "${base}/party/partydue/research/usedetail/save.action";
	detailform.submit();
}
</script>
