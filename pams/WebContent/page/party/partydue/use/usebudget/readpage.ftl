...
function page_apply()
{
	var url = "${base}/party/partydue/use/usebudget/apply.action?runactkey=${obj.runactkey}";	 
	window.location = url;
}
...
function page_edit()
{
	var url = "${base}/party/partydue/use/usebudget/locate.action?runactkey=${obj.runactkey}";	 
	window.location = url;
}
