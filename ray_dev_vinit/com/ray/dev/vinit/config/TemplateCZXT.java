...
public class TemplateCZXT
{
	public static List get_czxt()
	{
		List<String[]> items = new ArrayList();
		items.addAll(get_czxt_jbsx_all());
		items.addAll(get_czxt_gjsx_all());
		items.addAll(get_czxt_glsx_all());
		return items;
	}

	// 获取全部基本属性
	public static List<String[]> get_czxt_jbsx_all()
	{
		List<String[]> items = new ArrayList();
		...
		items.add(new String[]{ "操作系统类别", "czxtlb", "", "", ""});
	...
	// 获取全部固件属性
	public static List get_czxt_gjsx_all()
	{
		List<String[]> items = new ArrayList();
		
		items.addAll(get_czxt_gjsx_dk());
		
		return items;
	}
	
	//获取基本属性（端口子项）
	public static List get_czxt_gjsx_dk()
	{
		List<String[]> items = new ArrayList();
	...
	// 获取全部管理属性
	public static List<String[]> get_czxt_glsx_all()
	{
		List<String[]> items = new ArrayList();
		items.addAll(get_czxt_glsx());
		items.addAll(get_czxt_glsx_glzhxx());

		return items;
	}

	// 获取管理属性（简单属性）
	public static List get_czxt_glsx()
	{
		List<String[]> items = new ArrayList();
	...
	// 获取管理属性（管理账号信息子项）
	public static List get_czxt_glsx_glzhxx()
	{
		List<String[]> items = new ArrayList();
