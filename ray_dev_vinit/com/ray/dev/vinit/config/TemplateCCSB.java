...
public class TemplateCCSB
{
	public static List get_ccsb()
	{
		List<String[]> items = new ArrayList();
		items.addAll(get_ccsb_jbsx_all());
		items.addAll(get_ccsb_gjsx_all());
		items.addAll(get_ccsb_glsx_all());
		return items;
	}
	
	// 全体基本属性
	public static List get_ccsb_jbsx_all()
	{
		List<String[]> items = new ArrayList();
		...
		items.add(new String[]{"合同金额（元）","htje","","",""});
	...
	// 获取全部固件属性
	public static List<String[]> get_ccsb_gjsx_all()
	{
		List<String[]> items = new ArrayList();
		items.addAll(get_ccsb_gjsx());
		items.addAll(get_ccsb_gjsx_sanjhj());
		items.addAll(get_ccsb_gjsx_kzq());
		items.addAll(get_ccsb_gjsx_dy());

		return items;
	}
	// 获取固件属性（简单属性）
	public static List get_ccsb_gjsx()
	{
		List<String[]> items = new ArrayList();
		
		// 固件属性
		items.add(new String[]{"盘柜数量","pgsl","","",""});
		items.add(new String[]{"盘柜插槽数量","pgccsl","","",""});		
		items.add(new String[]{"RAID类型","raidlx","","",""});
		items.add(new String[]{"磁盘裸容量","cplrl","","",""});
		items.add(new String[]{"SAN交换机数量","sanjhjsl","","",""});
		items.add(new String[]{"磁盘净容量","cpjrl","","",""});	
		items.add(new String[]{"电源数量","dysl","","",""});
		items.add(new String[]{"控制器数量","kzqsl","","",""});	
		items.add(new String[]{"机架高度","jjgd","","",""});
		items.add(new String[]{"设备规格","sbgg","","",""});
		items.add(new String[]{"设备净重","sbjz","","",""});
		items.add(new String[]{"IP地址","ipdz","","",""});
		
		return items;
	}
	// 获取固件属性（SAN交换机子项）
	public static List get_ccsb_gjsx_sanjhj()
	{
		List<String[]> items = new ArrayList();
		
		// 固件属性.SAN交换机
		items.add(new String[]{"SAN交换机","sanjhj","1","",""});
	...
	// 获取固件属性（控制器子项）
	public static List get_ccsb_gjsx_kzq()
	{
		List<String[]> items = new ArrayList();
		
		// 固件属性.控制器
		items.add(new String[]{"控制器","kzq","1","",""});
	...
	// 获取固件属性（电源子项）
	public static List get_ccsb_gjsx_dy()
	{
		List<String[]> items = new ArrayList();
	...
	// 获取全部管理属性
	public static List get_ccsb_glsx_all()
	{
		List<String[]> items = new ArrayList();
		items.addAll(get_ccsb_glsx());
		items.addAll(get_ccsb_glsx_glzhxx());
		
		return items;
	}
	//获取管理属性（简单属性）
	public static List get_ccsb_glsx()
	{
		List<String[]> items = new ArrayList();
	...
	//获取管理属性（管理帐号信息子项）
	public static List get_ccsb_glsx_glzhxx()
	{
		List<String[]> items = new ArrayList();
